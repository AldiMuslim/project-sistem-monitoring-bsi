...
<head>
    ...
    <title>Register BSI Inventory - Premium Version</title>
...
<body>
    ...
    <div class="premium-card w-full max-w-[550px] rounded-[60px] p-12 md:p-16 z-10 text-center my-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-[10px] font-bold text-[#F2A900] uppercase tracking-[0.4em] mt-6">Daftar Akun Baru</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="relative text-left mb-4">
                <i class="fa-regular fa-user absolute left-6 top-1/2 -translate-y-1/2 text-gray-400"></i>
                <input type="text" name="name" value="{{ old('name') }}" required autofocus
                    placeholder="Masukkan Nama Lengkap Anda"
                    class="input-premium w-full rounded-2xl pl-14 pr-6 py-4 text-sm" autocomplete="name">
            </div>
            ...
            <div class="relative text-left mb-6">
                ...
                <input type="password" id="password_confirmation" name="password_confirmation" required
                    placeholder="Ulangi Password" class="input-premium w-full rounded-2xl pl-14 pr-14 py-4 text-sm"
